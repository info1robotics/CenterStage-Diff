package org.firstinspires.ftc.teamcode.roadrunner.followers
 ...
 * @param clock clock
 */
abstract class VariableTrajectoryFollower @JvmOverloads constructor(
    ...
    private fun internalIsFollowing(): Boolean {
        ...
        return timeRemaining > 0 || (!admissible && timeRemaining > -variableTimeout)
    }
